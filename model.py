...
class LidarCenterNetHead(BaseDenseHead, BBoxTestMixin):
    ...
    def __init__(self,
        ...
        # Remove 'type' and build loss functions
    ...
    def forward(self, feats):
        ...
        """
        return multi_apply(self.forward_single, feats)  #alter
        #return list(map(self.forward_single, feats))
   ...
   # @autocast(dtype=torch.float32, apply_to=('center_heatmap_preds', 'wh_preds', 'offset_preds', 'yaw_class_preds', 'yaw_res_preds', 'velocity_pred', 'brake_pred'))
